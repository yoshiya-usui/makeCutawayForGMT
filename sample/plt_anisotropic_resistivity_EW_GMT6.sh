...
gray=100/100/100
shift=-0.5
Boption=a${ah}f${fh}:"y(km)":/a${av}f${fv}:"Depth(km)":WSne
obsloc=../obs_loc.txt

in_file=rhoXX_GMT_iter${iter}.dat
ps_file=rhoXX_EW_iter${iter}.ps
...
ps_file=anisotropy_EW_iter${iter}.ps
...
ps_file=strike_EW_iter${iter}.ps
