...
/home/yusui/001_Code/makeCutawayForGMT/makeCutawayForGMT param_H.txt
...
set ps_file=resistivity_GMT.iter${iter}.H.ps
echo $in_file
echo $ps_file

set shift=-0.5
set Boption=a${ah}f${fh}:"y(km)":/a${av}f${fv}:"x(km)":WSne
#set Boption=a${ah}f${fh}:"Distance(km)":/a${av}f${fv}g0.1:"Depth(km)":WSne

psxy $in_file -CRcpt -JX$AreaSize -R$Hrange/$Vrange -B$Boption -M -P -X4 -Y8 -K -V -L >! $ps_file
awk '{print $2, $1}' loc.txt | psxy -J -R -G0/0/0 -Ss5p -O -K -P >> $ps_file
